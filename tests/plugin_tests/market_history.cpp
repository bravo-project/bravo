...
#include <bravo/market_history/market_history_plugin.hpp>
...
{
   using namespace bravo::market_history;
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->high_bravo == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_sbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bravo == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_sbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bravo == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_sbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bravo == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_sbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->bravo_volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->sbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->high_bravo == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bravo == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bravo == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bravo == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bravo_volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->sbd_volume == ASSET( "0.250 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->high_bravo == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bravo == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_bravo == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_bravo == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bravo_volume == ASSET( "0.950 TESTS" ).amount );
      ...
      BOOST_REQUIRE( bucket->close_bravo == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bravo_volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->sbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->open == BRAVO_GENESIS_TIME );
      BOOST_REQUIRE( bucket->high_bravo == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_bravo == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_sbd == ASSET( "0.750 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->close_bravo == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_sbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->bravo_volume == ASSET( "2.950 TESTS" ).amount );
