...
/*
namespace bravo { namespace plugin_tests {
...
BRAVO_DEFINE_PLUGIN( test, bravo::plugin_tests::test_plugin )

FC_REFLECT( bravo::plugin_tests::test_a_operation, (account) )
FC_REFLECT( bravo::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( bravo::plugin_tests::test_op );
FC_REFLECT_TYPENAME( bravo::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( bravo::plugin_tests::test_op );
*/
