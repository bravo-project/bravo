...
#include <bravo/manifest/plugins.hpp>
...
int main(int argc, char** argv) {
   bravo::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      bpo::options_description app_options("Bravo Daemon");
      bpo::options_description cfg_options("Bravo Daemon");
      app_options.add_options()
            ("help,h", "Print this help message and exit.")
            ("data-dir,d", bpo::value<boost::filesystem::path>()->default_value("witness_node_data_dir"), "Directory containing databases, configuration file, etc.")
            ("version,v", "Print bravod version and exit.")
            ;

      bpo::variables_map options;

      for( const std::string& plugin_name : bravo::plugin::get_available_plugins() )
         node->register_abstract_plugin( bravo::plugin::create_plugin( plugin_name, node ) );
      ...
      {
         std::cout << "bravo_blockchain_version: " << fc::string( BRAVO_BLOCKCHAIN_VERSION ) << "\n";
         std::cout << "bravo_git_revision:       " << fc::string( graphene::utilities::git_revision_sha ) << "\n";
