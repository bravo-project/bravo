...
target_link_libraries( {plugin_provider}_{plugin_name} bravo_app bravo_chain bravo_protocol )
...
{{
   public:
      {plugin_name}_api( const bravo::app::api_context& ctx );
...
class {plugin_name}_plugin : public bravo::app::plugin
{{
   public:
      {plugin_name}_plugin( bravo::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( bravo::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( bravo::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const bravo::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( bravo::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( bravo::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( bravo::app::application* app )
   : plugin(app)
{{
...
BRAVO_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (bravo for plugins developed by Bravo)")
