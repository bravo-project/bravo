...
namespace bravo { namespace chain {
   ...
   using bravo::protocol::chain_properties;
   using bravo::protocol::digest_type;
   using bravo::protocol::public_key_type;
   using bravo::protocol::version;
   using bravo::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Bravo blockchain version the witness is running.
          */
         version           running_version;

         hardfork_version  hardfork_version_vote;
         time_point_sec    hardfork_time_vote = BRAVO_GENESIS_TIME;
   };
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, BRAVO_MAX_WITNESSES >             current_shuffled_witnesses;
         ...
         uint8_t max_voted_witnesses            = BRAVO_MAX_VOTED_WITNESSES_HF0;
         uint8_t max_miner_witnesses            = BRAVO_MAX_MINER_WITNESSES_HF0;
         uint8_t max_runner_witnesses           = BRAVO_MAX_RUNNER_WITNESSES_HF0;
         uint8_t hardfork_required_witnesses    = BRAVO_HARDFORK_REQUIRED_WITNESSES;
   };
...
FC_REFLECT_ENUM( bravo::chain::witness_object::witness_schedule_type, (top19)(timeshare)(miner)(none) )

FC_REFLECT( bravo::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( bravo::chain::witness_schedule_object, bravo::chain::witness_schedule_index )
