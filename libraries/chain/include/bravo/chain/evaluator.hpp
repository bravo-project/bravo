...
template< typename OperationType=bravo::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=bravo::protocol::operation >
...
class X ## _evaluator : public bravo::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : bravo::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
