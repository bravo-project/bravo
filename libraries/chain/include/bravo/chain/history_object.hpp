...
FC_REFLECT( bravo::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::operation_object, bravo::chain::operation_index )

FC_REFLECT( bravo::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::account_history_object, bravo::chain::account_history_index )
