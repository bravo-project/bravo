...
FC_REFLECT( bravo::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::transaction_object, bravo::chain::transaction_index )
