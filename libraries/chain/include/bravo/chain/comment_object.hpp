...
namespace bravo { namespace chain {
   ...
   class comment_object : public object < comment_object_type, comment_object >
   {
      ...
      public:
         ...
         asset             total_payout_value = asset(0, BRAVO_SYMBOL);
         asset             curator_payout_value = asset(0, BRAVO_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, BRAVO_SYMBOL );
         ...
         asset             max_accepted_payout = asset( 1000000000, BRAVO_SYMBOL );       /// SBD value of the maximum payout this post will receive
...
FC_REFLECT( bravo::chain::comment_object,
             (id)(author)(permlink)
             ...
             (total_vote_weight)(reward_weight)(total_payout_value)(curator_payout_value)(beneficiary_payout_value)(author_rewards)(net_votes)(max_cashout_windows)(root_comment)
             (max_accepted_payout)(percent_bravo_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::comment_object, bravo::chain::comment_index )

FC_REFLECT( bravo::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::comment_vote_object, bravo::chain::comment_vote_index )
