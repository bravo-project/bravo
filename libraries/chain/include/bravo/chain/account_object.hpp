...
#include <bravo/chain/shared_authority.hpp>
...
namespace bravo { namespace chain {
   ...
   using bravo::protocol::authority;
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = BRAVO_NULL_ACCOUNT;
         ...
         bool              can_vote = true;
         uint16_t          voting_power = BRAVO_100_PERCENT;   ///< current voting power of this account, it falls after every vote
         time_point_sec    last_vote_time; ///< used to increase the voting power of this account the longer it goes without voting.

         asset             balance = asset( 0, BRAVO_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, BRAVO_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  BRAVO_MIN_COMPOUNDING_INTERVAL_SECONDS has past since sbd_last_interest_payment then
         ...
         asset             reward_bravo_balance = asset( 0, BRAVO_SYMBOL );
         ...
         fc::array<share_type, BRAVO_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( BRAVO_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
   ...
   typedef multi_index_container<
      ...
      indexed_by<
         ...
         >,
         ordered_unique< tag< by_bravo_balance >,
            composite_key< account_object,
...
FC_REFLECT( bravo::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( bravo::chain::account_object, bravo::chain::account_index )

FC_REFLECT( bravo::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( bravo::chain::account_authority_object, bravo::chain::account_authority_index )

FC_REFLECT( bravo::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::owner_authority_history_object, bravo::chain::owner_authority_history_index )

FC_REFLECT( bravo::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::account_recovery_request_object, bravo::chain::account_recovery_request_index )

FC_REFLECT( bravo::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::change_recovery_account_request_object, bravo::chain::change_recovery_account_request_index )
