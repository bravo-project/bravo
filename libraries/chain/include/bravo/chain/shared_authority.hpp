...
namespace bravo { namespace chain {
   ...
   using bravo::protocol::weight_type;
...
FC_REFLECT_TYPENAME( bravo::chain::shared_authority::account_authority_map)
FC_REFLECT( bravo::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
