...
#include <bravo/protocol/authority.hpp>
...
namespace bravo { namespace chain {
   ...
   using bravo::protocol::asset_symbol_type;

   typedef protocol::fixed_string_16 reward_fund_name_type;

   /**
    *  This object is used to track pending requests to convert sbd to bravo
    */
    ...
    *  1000 BRAVO or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return bravo_volume * sbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(bravo_volume,sbd_volume) * is_positive();
         }
         ...
         {
            return ( bravo_volume > 0 && sbd_volume > 0 ) ? 1 : 0;
         }
   };
...
#include <bravo/chain/comment_object.hpp>
#include <bravo/chain/account_object.hpp>

FC_REFLECT_ENUM( bravo::chain::curve_id,
                  (quadratic)(quadratic_curation)(linear)(square_root))

FC_REFLECT( bravo::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::limit_order_object, bravo::chain::limit_order_index )

FC_REFLECT( bravo::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::convert_request_object, bravo::chain::convert_request_index )

FC_REFLECT( bravo::chain::liquidity_reward_balance_object,
             (id)(owner)(bravo_volume)(sbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::liquidity_reward_balance_object, bravo::chain::liquidity_reward_balance_index )

FC_REFLECT( bravo::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::withdraw_vesting_route_object, bravo::chain::withdraw_vesting_route_index )

FC_REFLECT( bravo::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::savings_withdraw_object, bravo::chain::savings_withdraw_index )

FC_REFLECT( bravo::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (bravo_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::escrow_object, bravo::chain::escrow_index )

FC_REFLECT( bravo::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( bravo::chain::decline_voting_rights_request_object, bravo::chain::decline_voting_rights_request_index )

FC_REFLECT( bravo::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( bravo::chain::reward_fund_object, bravo::chain::reward_fund_index )
