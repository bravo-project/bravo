 ...
 * - Length is between (inclusive) BRAVO_MIN_ACCOUNT_NAME_LENGTH and BRAVO_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace bravo::protocol


FC_REFLECT_TYPENAME( bravo::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( bravo::protocol::authority::key_authority_map)
FC_REFLECT( bravo::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( bravo::protocol::authority::classification, (owner)(active)(key)(posting) )
