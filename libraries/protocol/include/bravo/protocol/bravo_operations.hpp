...
namespace bravo { namespace protocol {
   ...
   {
      FC_ASSERT( permlink.size() < BRAVO_MAX_PERMLINK_LENGTH, "permlink is too long" );
    ...
    *  The percent_bravo_dollars may be decreased, but never increased
    *
    */
   struct comment_options_operation : public base_operation
   {
      ...
      asset             max_accepted_payout    = asset( 1000000000, BRAVO_SYMBOL );       /// BRAVO value of the maximum payout this post will receive
      uint16_t          percent_bravo_dollars  = BRAVO_100_PERCENT; /// the percent of Bravo Dollars to key, unkept amounts will be received as Bravo Power
    ...
    * @ingroup operations
    *
    * @brief Transfers BRAVO from one account to another.
    */
   ...
   struct escrow_transfer_operation : public base_operation
   {
      ...
      asset             bravo_amount = asset( 0, BRAVO_SYMBOL );
      asset             fee;
   ...
   struct escrow_release_operation : public base_operation
   {
      ...
      uint32_t          escrow_id = 30;
      asset             bravo_amount = asset( 0, BRAVO_SYMBOL ); ///< the amount of bravo to release
   ...
   /**
    *  This operation converts BRAVO into VFS (Vesting Fund Shares) at
    ...
    * vests to bravo and back, guaranteeing they maintain their value.
    */
   ...
   {
      /**
       *  This fee, paid in BRAVO, is converted into VESTING SHARES for the new account. Accounts
       *  without vesting shares cannot earn usage rations and therefore are powerless. This minimum
       *  fee requires all accounts to have some kind of commitment to the network that includes the
       *  ability to vote and make transactions.
       */
      asset             account_creation_fee =
         asset( BRAVO_MIN_ACCOUNT_CREATION_FEE, BRAVO_SYMBOL );

      /**
       *  This witnesses vote for the maximum_block_size which is used by the network
       *  to tune rate limiting and capacity
       */
      uint32_t          maximum_block_size = BRAVO_MIN_BLOCK_SIZE_LIMIT * 2;

      void validate()const
      {
         FC_ASSERT( account_creation_fee.amount >= BRAVO_MIN_ACCOUNT_CREATION_FEE);
         FC_ASSERT( maximum_block_size >= BRAVO_MIN_BLOCK_SIZE_LIMIT);
      }
   };
   ...
   /**
    *  This operation instructs the blockchain to start a conversion between BRAVO and SBD,
    *  The funds are deposited after BRAVO_CONVERSION_DELAY
    */
    ...
    * BRAVO_MAX_WITNESSES blocks of the head block (1 round) and the
    * producer must be in the ACTIVE witness set.
    *
    * Users not in the ACTIVE witness set should not have to worry about their
    * key getting compromised and being used to produced multiple blocks so
    * the attacker can report it and steel their vesting bravo.
    *
    * The result of the operation is to transfer the full VESTING BRAVO balance
...
FC_REFLECT( bravo::protocol::transfer_to_savings_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bravo::protocol::transfer_from_savings_operation, (from)(request_id)(to)(amount)(memo) )
FC_REFLECT( bravo::protocol::cancel_transfer_from_savings_operation, (from)(request_id) )

FC_REFLECT( bravo::protocol::reset_account_operation, (reset_account)(account_to_reset)(new_owner_authority) )
FC_REFLECT( bravo::protocol::set_reset_account_operation, (account)(current_reset_account)(reset_account) )


FC_REFLECT( bravo::protocol::report_over_production_operation, (reporter)(first_block)(second_block) )
FC_REFLECT( bravo::protocol::convert_operation, (owner)(requestid)(amount) )
FC_REFLECT( bravo::protocol::pow, (worker)(input)(signature)(work) )
FC_REFLECT( bravo::protocol::pow2, (input)(pow_summary) )
FC_REFLECT( bravo::protocol::pow2_input, (worker_account)(prev_block)(nonce) )
FC_REFLECT( bravo::protocol::equihash_pow, (input)(proof)(prev_block)(pow_summary) )
FC_REFLECT( bravo::protocol::chain_properties, (account_creation_fee)(maximum_block_size) );

FC_REFLECT_TYPENAME( bravo::protocol::pow2_work )
FC_REFLECT( bravo::protocol::pow_operation, (worker_account)(block_id)(nonce)(work)(props) )
FC_REFLECT( bravo::protocol::pow2_operation, (work)(new_owner_key)(props) )

FC_REFLECT( bravo::protocol::account_create_operation,
            (fee)
            (creator)
            (new_account_name)
            (owner)
...
FC_REFLECT( bravo::protocol::account_update_operation,
            (account)
            (owner)
            (active)
            (posting)
...
FC_REFLECT( bravo::protocol::transfer_operation, (from)(to)(amount)(memo) )
FC_REFLECT( bravo::protocol::transfer_to_vesting_operation, (from)(to)(amount) )
FC_REFLECT( bravo::protocol::set_withdraw_vesting_route_operation, (from_account)(to_account)(percent)(auto_vest) )
FC_REFLECT( bravo::protocol::witness_update_operation, (owner)(url)(block_signing_key)(props)(fee) )
FC_REFLECT( bravo::protocol::account_witness_vote_operation, (account)(witness)(approve) )
FC_REFLECT( bravo::protocol::account_witness_proxy_operation, (account)(proxy) )
FC_REFLECT( bravo::protocol::comment_operation, (parent_author)(parent_permlink)(author)(permlink)(title)(body)(json_metadata) )
FC_REFLECT( bravo::protocol::vote_operation, (voter)(author)(permlink)(weight) )
FC_REFLECT( bravo::protocol::custom_operation, (required_auths)(id)(data) )
FC_REFLECT( bravo::protocol::custom_json_operation, (required_auths)(required_posting_auths)(id)(json) )
FC_REFLECT( bravo::protocol::custom_binary_operation, (required_owner_auths)(required_active_auths)(required_posting_auths)(required_auths)(id)(data) )
FC_REFLECT( bravo::protocol::limit_order_create_operation, (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration) )
FC_REFLECT( bravo::protocol::limit_order_create2_operation, (owner)(orderid)(amount_to_sell)(exchange_rate)(fill_or_kill)(expiration) )
FC_REFLECT( bravo::protocol::limit_order_cancel_operation, (owner)(orderid) )

FC_REFLECT( bravo::protocol::delete_comment_operation, (author)(permlink) );

FC_REFLECT( bravo::protocol::beneficiary_route_type, (account)(weight) )
FC_REFLECT( bravo::protocol::comment_payout_beneficiaries, (beneficiaries) )
FC_REFLECT_TYPENAME( bravo::protocol::comment_options_extension )
FC_REFLECT( bravo::protocol::comment_options_operation, (author)(permlink)(max_accepted_payout)(percent_bravo_dollars)(allow_votes)(allow_curation_rewards)(extensions) )

FC_REFLECT( bravo::protocol::escrow_transfer_operation, (from)(to)(bravo_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
FC_REFLECT( bravo::protocol::escrow_approve_operation, (from)(to)(agent)(who)(escrow_id)(approve) );
FC_REFLECT( bravo::protocol::escrow_dispute_operation, (from)(to)(agent)(who)(escrow_id) );
FC_REFLECT( bravo::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(bravo_amount) );
FC_REFLECT( bravo::protocol::challenge_authority_operation, (challenger)(challenged)(require_owner) );
FC_REFLECT( bravo::protocol::prove_authority_operation, (challenged)(require_owner) );
FC_REFLECT( bravo::protocol::request_account_recovery_operation, (recovery_account)(account_to_recover)(new_owner_authority)(extensions) );
FC_REFLECT( bravo::protocol::recover_account_operation, (account_to_recover)(new_owner_authority)(recent_owner_authority)(extensions) );
FC_REFLECT( bravo::protocol::change_recovery_account_operation, (account_to_recover)(new_recovery_account)(extensions) );
FC_REFLECT( bravo::protocol::decline_voting_rights_operation, (account)(decline) );
FC_REFLECT(bravo::protocol::claim_reward_balance_operation, (account)(reward_bravo));
