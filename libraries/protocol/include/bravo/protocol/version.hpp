...
/*
 * This class represents the basic versioning scheme of the Bravo blockchain.
...
{
   class variant;
   void to_variant( const bravo::protocol::version& v, variant& var );
   void from_variant( const variant& var, bravo::protocol::version& v );

   void to_variant( const bravo::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, bravo::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( bravo::protocol::version, (v_num) )
FC_REFLECT_DERIVED( bravo::protocol::hardfork_version, (bravo::protocol::version), )

FC_REFLECT( bravo::protocol::hardfork_version_vote, (hf_version)(hf_time) )
