...
{
   price                order_price;
   double               real_price; // dollars per bravo
   share_type           bravo;
   share_type           sbd;
...
{
   public:
      database_api(const bravo::app::api_context& ctx);
      ~database_api();
...
FC_REFLECT( bravo::app::order, (order_price)(real_price)(bravo)(sbd)(created) );
FC_REFLECT( bravo::app::order_book, (asks)(bids) );
FC_REFLECT( bravo::app::scheduled_hardfork, (hf_version)(live_time) );
FC_REFLECT( bravo::app::liquidity_balance, (account)(weight) );
FC_REFLECT( bravo::app::withdraw_route, (from_account)(to_account)(percent)(auto_vest) );

FC_REFLECT( bravo::app::discussion_query, (tag)(filter_tags)(select_tags)(select_authors)(truncate_body)(start_author)(start_permlink)(parent_author)(parent_permlink)(limit) );

FC_REFLECT_ENUM( bravo::app::withdraw_route_type, (incoming)(outgoing)(all) );

FC_API(bravo::app::database_api,
   // Subscriptions
