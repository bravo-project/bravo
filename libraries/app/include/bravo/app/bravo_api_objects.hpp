...
#include <bravo/tags/tags_plugin.hpp>
...
struct comment_api_obj
{
   comment_api_obj( const chain::comment_object& o ):
      ...
      max_cashout_windows( o.max_cashout_windows ),
      root_comment( o.root_comment ),
      max_accepted_payout( o.max_accepted_payout ),
      percent_bravo_dollars( o.percent_bravo_dollars ),
   ...
   int32_t           net_votes = 0;
   uint8_t           max_cashout_windows = 0;

   comment_id_type   root_comment;

   asset             max_accepted_payout;
   uint16_t          percent_bravo_dollars = 0;
...
struct account_api_obj
{
   account_api_obj( const chain::account_object& a, const chain::database& db ) :
      ...
      reward_bravo_balance( a.reward_bravo_balance ),
...
FC_REFLECT( bravo::app::comment_api_obj,
             (id)(author)(permlink)
             ...
             (total_vote_weight)(reward_weight)(total_payout_value)(curator_payout_value)(author_rewards)(net_votes)(max_cashout_windows)(root_comment)
             (max_accepted_payout)(percent_bravo_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( bravo::app::account_api_obj,
...
FC_REFLECT( bravo::app::owner_authority_history_api_obj,
             (id)
             (account)
...
FC_REFLECT( bravo::app::account_recovery_request_api_obj,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( bravo::app::savings_withdraw_api_obj,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( bravo::app::tag_api_obj,
            (name)
            (total_payouts)
            (net_votes)
            (top_posts)
...
FC_REFLECT( bravo::app::witness_api_obj,
             (id)
             (owner)
             (created)
...
FC_REFLECT_DERIVED( bravo::app::signed_block_api_obj, (bravo::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT_DERIVED( bravo::app::dynamic_global_property_api_obj, (bravo::chain::dynamic_global_property_object),
