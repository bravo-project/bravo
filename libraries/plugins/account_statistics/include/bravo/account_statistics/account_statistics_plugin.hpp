...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_bravo_value = 0;     ///< BRAVO Value of author rewards
   ...
   share_type           curation_rewards_bravo_value = 0;         ///< BRAVO Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of BRAVO paid as liquidity rewards
   ...
   share_type           bravo_sent = 0;                           ///< BRAVO sent from this account
   share_type           bravo_received = 0;                       ///< BRAVO received by this account
   ...
   share_type           bravo_vested = 0;                         ///< BRAVO vested by the account
   ...
   share_type           bravo_received_from_withdrawls = 0;       ///< BRAVO received from this account's vesting withdrawals
   share_type           bravo_received_from_routes = 0;           ///< BRAVO received from another account's vesting withdrawals
   ...
   share_type           bravo_converted = 0;                      ///< Amount of BRAVO that was converted
   ...
   share_type           limit_order_bravo_paid = 0;               ///< BRAVO paid by limit orders
   share_type           limit_order_bravo_received = 0;           ///< BRAVO received from limit orders
...
class account_statistics_plugin : public bravo::app::plugin
{
   public:
...
FC_REFLECT( bravo::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
   ...
   (vests_withdrawn)
   (bravo_received_from_withdrawls)
   (bravo_received_from_routes)
   ...
   (limit_order_bravo_paid)
   (limit_order_bravo_received)
   (limit_order_sbd_paid)
   (limit_order_sbd_received)
   (total_pow)
   (estimated_hashpower)
)
//SET_INDEX_TYPE( bravo::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   bravo::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
