...
)
{
   ...
   bravo::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   bravo::chain::database& db = database();
   ...
   while( produced < count )
   {
      ...
      bravo::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
...
BRAVO_DEFINE_PLUGIN( debug_node, bravo::plugin::debug_node::debug_node_plugin )
