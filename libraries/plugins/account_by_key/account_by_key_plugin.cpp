#include <bravo/account_by_key/account_by_key_plugin.hpp>
...
struct post_operation_visitor
{
   ...
   {
      if( op.hardfork_id == BRAVO_HARDFORK_0_9 )
      {
...
account_by_key_plugin::account_by_key_plugin( bravo::app::application* app )
...
BRAVO_DEFINE_PLUGIN( account_by_key, bravo::account_by_key::account_by_key_plugin )
