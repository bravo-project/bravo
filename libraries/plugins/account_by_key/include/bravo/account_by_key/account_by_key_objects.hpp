...
FC_REFLECT( bravo::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( bravo::account_by_key::key_lookup_object, bravo::account_by_key::key_lookup_index )
