#include <bravo/blockchain_statistics/blockchain_statistics_api.hpp>
...
struct operation_process
{
   ...
   void operator()( const transfer_operation& op )const
   {
      _db.modify( _bucket, [&]( bucket_object& b )
      {
         ...
         if( op.amount.symbol == BRAVO_SYMBOL )
            b.bravo_transferred += op.amount.amount;
         else
   ...
   void operator()( const transfer_to_vesting_operation& op )const
   {
      _db.modify( _bucket, [&]( bucket_object& b )
      {
         ...
         b.bravo_vested += op.amount.amount;
      });
   }
...
BRAVO_DEFINE_PLUGIN( blockchain_statistics, bravo::blockchain_statistics::blockchain_statistics_plugin );
