...
class blockchain_statistics_plugin : public bravo::app::plugin
{
   public:
...
FC_REFLECT( bravo::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( bravo::blockchain_statistics::bucket_object, bravo::blockchain_statistics::bucket_index )
