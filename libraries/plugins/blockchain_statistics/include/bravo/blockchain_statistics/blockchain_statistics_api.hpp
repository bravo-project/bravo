...
#include <bravo/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
namespace bravo { namespace blockchain_statistics {
...
struct statistics
{
   ...
   share_type           bravo_transferred = 0;                       ///< BRAVO transferred from account to account
   ...
   share_type           liquidity_rewards_paid = 0;                  ///< Ammount of BRAVO paid to market makers
   uint32_t             transfers_to_vesting = 0;                    ///< Transfers of BRAVO into VESTS
   share_type           bravo_vested = 0;                            ///< Ammount of BRAVO vested
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to BRAVO
...
{
   public:
      blockchain_statistics_api( const bravo::app::api_context& ctx );
...
} } // bravo::blockchain_statistics

FC_REFLECT( bravo::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( bravo::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
