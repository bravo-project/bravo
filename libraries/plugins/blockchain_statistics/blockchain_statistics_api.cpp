...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( bravo::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const bravo::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->bravo_transferred                      += b.bravo_transferred;
   ...
   this->bravo_vested                           += b.bravo_vested;
   ...
   this->bravo_converted                        += b.bravo_converted;
