...
using bravo::protocol::fill_order_operation;
      ...
      for( auto bucket : _tracked_buckets )
      {
         ...
         if( itr == bucket_idx.end() )
         {
            db.create< bucket_object >( [&]( bucket_object& b )
            {
               ...
               if( op.open_pays.symbol == BRAVO_SYMBOL )
               {
                  b.high_bravo = op.open_pays.amount;
                  b.high_sbd = op.current_pays.amount;
                  b.low_bravo = op.open_pays.amount;
                  b.low_sbd = op.current_pays.amount;
                  b.open_bravo = op.open_pays.amount;
                  b.open_sbd = op.current_pays.amount;
                  b.close_bravo = op.open_pays.amount;
                  b.close_sbd = op.current_pays.amount;
                  b.bravo_volume = op.open_pays.amount;
                  b.sbd_volume = op.current_pays.amount;
               }
               else
               {
                  b.high_bravo = op.current_pays.amount;
                  b.high_sbd = op.open_pays.amount;
                  b.low_bravo = op.current_pays.amount;
                  b.low_sbd = op.open_pays.amount;
                  b.open_bravo = op.current_pays.amount;
                  b.open_sbd = op.open_pays.amount;
                  b.close_bravo = op.current_pays.amount;
                  b.close_sbd = op.open_pays.amount;
                  b.bravo_volume = op.current_pays.amount;
...
BRAVO_DEFINE_PLUGIN( market_history, bravo::market_history::market_history_plugin )
