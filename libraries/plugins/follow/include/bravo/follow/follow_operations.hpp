...
FC_REFLECT( bravo::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( bravo::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( bravo::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( bravo::follow::follow_plugin_operation )
