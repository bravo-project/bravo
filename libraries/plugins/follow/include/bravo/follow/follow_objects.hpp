...
FC_REFLECT_ENUM( bravo::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( bravo::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::follow_object, bravo::follow::follow_index )

FC_REFLECT( bravo::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::feed_object, bravo::follow::feed_index )

FC_REFLECT( bravo::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::blog_object, bravo::follow::blog_index )

FC_REFLECT( bravo::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::reputation_object, bravo::follow::reputation_index )

FC_REFLECT( bravo::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::follow_count_object, bravo::follow::follow_count_index )

FC_REFLECT( bravo::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( bravo::follow::blog_author_stats_object, bravo::follow::blog_author_stats_index );
