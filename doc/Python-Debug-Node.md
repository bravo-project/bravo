...
of a running Bravo Debug Node. The Debug Node is a plugin for Bravo that allows realtime
...
[Python Bravo library](https://github.com/xeroc/python-bravolib).
...
To use the script include `from bravodebugnode import DebugNode`

There are a couple of examples already made that you can try modifying yourself.

[debug_hardforks.py](https://github.com/bravocoin/bravo/python_scripts/tests/debug_hardforks.py)
...
[debugnode.py](https://github.com/bravocoin/bravo/python_scripts/bravodebugnode/debugnode.py#L212)
...
specify the bravod binary location and a populated data directory. For most configurations
this will be `programs/bravod/bravod` and `witness_node_data_dir` respectively, from the
git root directory for Bravo.
