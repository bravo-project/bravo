...
operation_tests      // Unit Tests of Bravo operations
operation_time_tests // Tests of Bravo operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_BRAVO_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
